...
/**
 * B463 semantic cross-app routing.
 *
 * The router composes already registered Android capability providers. It performs no Android API
 * call and no external action. Inputs are accumulated only from declared provider output contracts;
 * a later step cannot assume data that no earlier provider contract produced.
 */
