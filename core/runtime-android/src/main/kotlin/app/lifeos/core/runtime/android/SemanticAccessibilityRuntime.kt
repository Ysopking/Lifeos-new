...
/**
 * B464C semantic accessibility boundary.
 *
 * It exposes a structured PROJECTED observation and precondition-bound action candidates only.
 * Productive UI execution is intentionally outside this type and must pass platform permission,
