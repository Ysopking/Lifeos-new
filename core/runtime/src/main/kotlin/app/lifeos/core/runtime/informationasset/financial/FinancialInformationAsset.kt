...
/**
 * Financial values and conclusions must retain finance-domain evidence. Owner-provided figures are
 * legitimate inputs, but UNVERIFIED material alone cannot be promoted into supported financial
