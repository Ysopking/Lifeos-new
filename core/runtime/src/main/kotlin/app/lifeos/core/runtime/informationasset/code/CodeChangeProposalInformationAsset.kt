...
enum class CodeChangeOperation { ADD, MODIFY, DELETE, RENAME, REFACTOR, CONFIGURE }

data class CodeChangeTarget(val path: String, val symbol: String? = null) {
    init {
...
enum class CodeChangeRiskLevel { LOW, MEDIUM, HIGH, CRITICAL }
