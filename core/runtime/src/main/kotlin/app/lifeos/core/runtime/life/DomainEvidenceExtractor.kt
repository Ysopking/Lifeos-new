...
object DomainEvidenceExtractor {
    ...
    private val QUESTION_WORDS = setOf("warum", "wieso", "wie ", "was ", "welche", "where", "why", "how ")
    private val KNOWLEDGE_GAP_WORDS = setOf("weiß nicht", "unklar", "fehlt", "herausfinden", "recherch", "unknown", "missing", "find out")
    private val LEGAL_WORDS = setOf("vertrag", "recht", "gesetz", "kündig", "mahnung", "anspruch", "klage", "gericht", "haftung")
    private val OBLIGATION_WORDS = setOf("muss", "verpflicht", "schuldet", "zu zahlen", "leisten", "pflicht")
    private val DEADLINE_WORDS = setOf("frist", "bis zum", "fällig", "deadline", "spätestens")
    private val CLAIM_WORDS = setOf("forderung", "anspruch", "mahnung", "rechnung", "claim")
    private val DEBT_WORDS = setOf("schuld", "schulden", "forderung", "mahnung", "rückstand", "inkasso", "kredit")
    private val CREDITOR_WORDS = setOf("gläubiger", "creditor", "inkasso", "forderung von")
    private val PAYMENT_WORDS = setOf("zahlung", "bezahlen", "überweisen", "rate", "tilgung", "fällig")
    private val OPPORTUNITY_WORDS = setOf("chance", "möglichkeit", "wachstum", "neuer kunde", "umsatz", "markt", "opportunity")
    private val RISK_WORDS = setOf("risiko", "verlust", "kostensteiger", "engpass", "problem", "bedrohung", "risk")
    private val KPI_WORDS = setOf("umsatz", "marge", "gewinn", "kosten", "cashflow", "conversion", "kpi")
}
