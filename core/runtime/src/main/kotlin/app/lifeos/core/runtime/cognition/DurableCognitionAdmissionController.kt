 ...
 * idempotent work is always allowed through even when the backlog is full, so CREATED tasks can
 * still be resumed and duplicate semantic work never creates a second task. A task-ledger
 * integrity failure fails closed rather than admitting unbounded new work.
 */
