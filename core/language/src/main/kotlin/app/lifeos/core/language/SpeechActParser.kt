...
class SpeechActParser private constructor(
    ...
    companion object {
        val DIRECT_COMMAND_VERBS = setOf(
            ...
            "sende", "schicke", "schick", "schreibe", "schreib", "maile", "mail", "teile", "share", "send", "reply", "antworte",
            "gib", "sag", "lass", "let",
            "erinnere", "plane", "trag", "trage", "schedule", "remind",
            "merke", "merk", "behalt", "behalte", "speichere", "remember", "store", "save",
            "baue", "implementiere", "entwickle", "programmiere", "umsetze", "umsetz", "setze", "setz", "build", "implement", "develop", "code",
            "zieh",
