        ...
        LifeOsStartupComposition.start(
            LifeOsStartupHooks(
                installSharedResourceRuntime = {
                    SharedResourceBudgetRuntimeRegistry.install(
                    ...
                    ExternalEffectRuntimeRegistry.install(
                        PolicyGatedExternalEffectExecutor(
                            ...
                            receipts =
                                EncryptedExternalEffectReceiptRepository(appContext),
                            payloads =
                                EncryptedExternalPayloadRepository(appContext),
                            transport =
                                ExternalTransportRuntimeRegistry.transport(),
                            observationReconciler =
                                ExternalTransportRuntimeRegistry.reconciler(),
                        )
                    )
                    resourceBudgets = ResourceBudgetCoordinator(
                        EncryptedResourceBudgetRepository(appContext)
                    )
                    decisionTraces = DecisionTraceLedger(
                        EncryptedDecisionTraceRepository(appContext)
                    )
                    selfObservationDecisionTraceRecorder =
                        ...
                        GeneratedProviderRestoreAuthority(
                            ...
                            scope =
                                PrivateOwnerPolicyBaseline
                                    .GENERATED_PROVIDER_RESTORE_SCOPE,
                        )
                    )
                },
