...
- J — ACTIVE / IMPLEMENTATION ADVANCED
  ...
  - new on J branch: `DomainEvidencePersistence.kt` introduces a lossless evidence-v2 schema and productive convergence coordinator seam
  - open before COMPLETE: wire the coordinator at derived-Photon persistence, add migration/fail-closed tests, then exact-head Android Debug CI, cold-restart/recovery and Product Gold
