...
step "V17 gate 02: mandatory Gold coverage contract"
bash .github/scripts/ci-gold-coverage-contract.sh

step "V17 gate 03: complete core fast regression set"
bash .github/scripts/ci-core-fast.sh

step "V17 gate 04: all unit tests, lint and private debug APK"
bash .github/scripts/ci-android-debug.sh

step "V17 gate 05: emulator recovery preflight"
bash .github/scripts/ci-emulator-preflight.sh

step "V17 gate 06: immutable candidate evidence"
test -f "$apk_path"
